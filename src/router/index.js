...
export const constantRouterMap = [
	...
	{ path: '/login',name: 'login',component: resolve => require(['@/page/login'], resolve),hidden: true},
	{ path: '/404', component: resolve => require(['@/page/errorPage/404'], resolve), hidden: true },
  { path: '/401', component: resolve => require(['@/page/errorPage/401'], resolve), hidden: true },
	{
		path: '/index',
		name: 'index',
		component:Layout,
...
export const asyncRouterMap = [
		...
		children:[
			{
				...
				component: resolve => require(['@/page/userList/userList'], resolve),
			}
		]
	},
	{
		...
		children:[
		  {
			...
			component: resolve => require(['@/page/fundList/fundList'], resolve),
		  },
		  {
			path:'chinaTabsList',
			name:'chinaTabsList',
			...
			component: resolve => require(['@/page/fundList/chinaTabsList'], resolve),
			}
		]
	},
	{
		...
		children:[
		  {
			 ...
			 component: resolve => require(['@/page/fundData/fundPosition'], resolve)
		  },
		  {
			  path:'typePosition',
			  name:'typePosition',
			  meta: {
				...
				component: resolve => require(['@/page/fundData/typePosition'], resolve)
		   },
		   {
				...
				component: resolve => require(['@/page/fundData/incomePayPosition'], resolve)
		    }
		]
	},
	{
    ...
    children: [{
      ...
      component: resolve => require(['@/page/permission/page'], resolve),
    }, {
			path: 'directive',
			name: 'directivePer',
      meta: {
      ...
      component: resolve => require(['@/page/permission/directive'], resolve),
    }]
  },
  {
    path: '/error',
    ...
    children: [
			{  
				path: '401', 
				name: 'page401', 
				component: resolve => require(['@/page/errorPage/401'], resolve), 
				meta: { 
					title: '401', 
					noCache: true 
			  }
			},
			{
				path: '404', 
				name: 'page404', 
				component: resolve => require(['@/page/errorPage/404'], resolve), 
				meta: { 
					title: '404', 
					noCache: true
				}
	 ...
	 * 
	 * 按需加载路由组件的2种方法：
	 * 1、component: resolve => require(['@/page/login'], resolve)
